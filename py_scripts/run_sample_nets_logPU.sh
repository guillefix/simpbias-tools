#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Tue Sep 25 20:58:54 BST 2018      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -n 500 --mpi=pmi2 --mem-per-cpu=100 nice -n 10 /users/guillefix/bias/nn_bias/./run_sample_nets_logPU 
