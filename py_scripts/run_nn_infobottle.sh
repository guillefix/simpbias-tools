#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Fri Jul 27 12:28:10 BST 2018      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -n 300 --mpi=pmi2 --mem-per-cpu=1000 nice -n 10 /users/guillefix/bias/nn_bias/./run_nn_infobottle 2 relu
