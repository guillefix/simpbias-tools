#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Tue Mar 27 13:46:54 BST 2018      
date_start=`date +%s`
...
#ulimit -l
#which mpirun
 /usr/local/shared/slurm/bin/srun -n 100 --mpi=pmi2 --mem-per-cpu=1000 nice -n 10 /users/guillefix/bias/nn_bias/./run_CSR_bias_shallow_test 0
