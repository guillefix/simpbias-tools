#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Mon Apr  9 19:25:00 BST 2018      
date_start=`date +%s`
...
#ulimit -l
#which mpirun
 /usr/local/shared/slurm/bin/srun -n 250 --mpi=pmi2 --mem-per-cpu=1000 nice -n 10 /users/guillefix/bias/nn_bias/./run_CSR_bias_shallow 4 0
