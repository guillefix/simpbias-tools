...
inputs = [[float(xx) for xx in "{0:07b}".format(i)] for i in range(2**input_dim)]
...
pickle.dump(cnt, open( str(idx)+"_cnt_"+str(N*paral_nets)+"_7_"+str(hidden_layer_dim)+"_1_allinputs_relu.p", "wb" ), -1)
#pickle.dump(weights, open( str(idx)+"_weights_"+str(N*paral_nets)+"_7_"+str(hidden_layer_dim)+"_1_allinputs_relu.p", "wb" ), -1)
