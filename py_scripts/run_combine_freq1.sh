#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Wed Jan 24 20:58:14 GMT 2018      
date_start=`date +%s`
...
#ulimit -l
#which mpirun
 /usr/local/shared/slurm/bin/srun -n 1 --mpi=pmi2 --mem-per-cpu=16000 nice -n 10 /users/guillefix/bias/nn_bias/./run_combine_freq1 
