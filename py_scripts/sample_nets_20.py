...
inputs = [[float(xx) for xx in "{0:010b}".format(i)] for i in range(2**input_dim)]
...
pickle.dump(cnt, open( str(idx)+"_cnt_"+str(N*paral_nets)+"_"+str(input_dim)+"_"+str(hidden_layer_dim)+"_"+str(hidden_layer2_dim)+"_1_allinputs_relu.p", "wb" ), -1)
