#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Wed Sep 26 14:31:28 BST 2018      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -n 500 --mpi=pmi2 --mem-per-cpu=100 nice -n 10 /users/guillefix/bias/nn_bias/./run_logPU_sample_nets2 
