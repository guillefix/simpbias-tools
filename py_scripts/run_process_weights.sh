#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Tue Feb  6 12:04:37 GMT 2018      
date_start=`date +%s`
...
#ulimit -l
#which mpirun
 /usr/local/shared/slurm/bin/srun -n 1 --mpi=pmi2 --mem-per-cpu=6000 nice -n 10 /users/guillefix/bias/nn_bias/./run_process_weights 
