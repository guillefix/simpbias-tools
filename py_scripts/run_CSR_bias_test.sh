#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Thu Mar 22 23:53:58 GMT 2018      
date_start=`date +%s`
...
#ulimit -l
#which mpirun
 /usr/local/shared/slurm/bin/srun -n 1 --mpi=pmi2 --mem-per-cpu=4000 nice -n 10 /users/guillefix/bias/nn_bias/./run_CSR_bias_test 
